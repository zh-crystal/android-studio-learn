...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        switch (note.getPriority().intValue) {
            case 1:
                itemView.setBackgroundColor(Color.GREEN); break;
            case 2:
                itemView.setBackgroundColor(Color.RED); break;
            default:
                itemView.setBackgroundColor(Color.WHITE); break;
        }
    }
}
